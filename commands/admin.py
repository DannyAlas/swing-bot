...
class RolePreserver(Command):
    ...
    min_level = 3
    min_display = "3+"
    description = "Causes ⟨Swing⟩ to save roles for all users, and re-add them when they leave and rejoin."
...
class NickPreserver(Command):
    ...
    min_level = 3
    min_display = "3+"
    description = "Causes ⟨Swing⟩ to save nicknames for all users, and re-add them when they leave and rejoin."
    usage = "(enable|disable)?"
    flags = "aed"
...
class ThreadPreserver(Command):
    ...
    min_level = 3
    min_display = "3+"
    description = 'Causes ⟨Swing⟩ to "bump" (revive) the current thread when auto-archived.'
    usage = "(enable|disable)?"
    flags = "aed"
...
class UserLog(Command):
    ...
    name = ["MemberLog"]
    min_level = 3
    description = "Causes ⟨Swing⟩ to log user and member events from the server, in the current channel."
    usage = "(enable|disable)?"
    flags = "aed"
    rate_limit = 1
...
class MessageLog(Command):
    server_only = True
    min_level = 3
    description = "Causes ⟨Swing⟩ to log message events from the server, in the current channel."
    usage = "(enable|disable)?"
    flags = "aed"
    rate_limit = 1
...
class FileLog(Command):
    server_only = True
    min_level = 3
    description = "Causes ⟨Swing⟩ to log deleted files from the server, in the current channel."
    usage = "(enable|disable)?"
    flags = "aed"
    rate_limit = 1
...
class StarBoard(Command):
    server_only = True
    min_level = 2
    description = "Causes ⟨Swing⟩ to repost popular messages with a certain number of a specified reaction anywhere from the server, into the current channel."
...
class Crosspost(Command):
    ...
    min_level = 3
    description = "Causes ⟨Swing⟩ to automatically crosspost all messages from the target channel, into the current channel."
...
class Publish(Command):
    ...
    min_level = 3
    description = "Causes ⟨Swing⟩ to automatically publish all posted messages in the current channel."
