...
class AudioDownloader:
    ...
    # Extracts full data for a single entry. Uses cached results for optiSwingtion.
...
class Radio(Command):
    name = ["FM"]
    description = "Searches for a radio station livestream on https://worldradiomap.com that can be played on ⟨Swing⟩."
